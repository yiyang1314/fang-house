...
<!-- 								<li id="sl648"><a href="#" class="sla648">媒体报道</a></li> -->
								<c:forEach items="${news_nemu_list}" var="menu">
									<li ><a target="newsframe" href="${menu.menuUrl }?menuid=${menu.menuid}" class="sla648">${menu.menuName }</a></li>
								</c:forEach>
				...
				<div class="main_box_inner_right">
					<div class="smallbanner">
						<div style="border: 1px solid #CBCBCB; padding: 3px 3px 0 3px;">
							<img src="client/e/images/home/nut_1.jpg">
						</div>
					</div>
					<div class="current_location current_location_547">
						<ul>
							<li class="current_location_1">当前位置：<a href= />首页</a> &gt; <a
								href="../news/" class="cl_1">新闻中心</a> &gt; <a href="#">公司新闻</a></li>
							<li class="current_location_2">公司新闻</li>
						</ul>
					</div>
<!-- 					新闻内容---开始 -->
					<div class="sublanmu_box sublanmu_box_547">
						<iframe id="newsframe" name="newsframe" src="client/firstpage/news/container_news.jsp" scrolling="no">
						</iframe>
					</div>
					<!-- 					新闻内容---结束 -->
				</div>
