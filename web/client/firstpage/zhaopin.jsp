	...
	<div class="main_box main_box_style1">
			<div class="main_box_inner">
				<div class="main_box_inner_left">
					<div id="nav_116" class="nav_box nav_box_menu">

						<div class="nav_title">
							<span class="nav_sign">人才招聘</span><span class="nav_more"></span>
						</div>
						<div id="nav_menu_116" class="nav_menu">
							<ul id="rootul_116">
								<c:forEach items="${zhaopin_nemu_list}" var="menu">
									<li ><a href="${menu.menuUrl }?menuid=${menu.menuid}" class="sla648" target="zhaopinframe">${menu.menuName }</a></li>
								</c:forEach>
					...
					<script type="text/javascript">
						shut_allsubnav("rootul_116");
						expand_subnav("sl602", "0");
					</script>
				...
				<div class="main_box_inner_right">
					...
					<div class="current_location current_location_602">
						<ul>
							<li class="current_location_1">当前位置：<a href= />首页</a> &gt; <a
								href="../rczp/">人才招聘</a> &gt; <a href="#">招聘职位</a></li>
							<li class="current_location_2">招聘职位</li>
						</ul>
					</div>
					<div class="sublanmu_box sublanmu_box_602">
						<iframe id="zhaopinframe" name="zhaopinframe" src="client/firstpage/zhaopin/container_zhaopin.jsp" frameborder="0" width="100%"   >
						</iframe>
					</div>
				</div>
