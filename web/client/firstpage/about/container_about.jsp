...
<html>
	...
	<link href="client/e/templates/150716/style.css" type="text/css" rel="stylesheet" />
		...
		$(function() {
			...
			$(parent.document.getElementById("aboutframe")).height(h);
			var  parentheight=$(parent.document.getElementById("aboutframe")).height();

			
			$(parent.document.getElementById("aboutframe")).parent().height(parentheight+2);
